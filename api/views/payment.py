        ...
        try:
            ...
            product_dict = {
                1: {
                    ...
                    choice_policy_id: 2,
                    price_policy_list:[
                        {'id': 1, 'period': 1个月,'valid_period': 30, 'price': 10},
                        {'id': 2, 'period': 2个月,'valid_period': 60, 'price': 20},
                        {'id': 3, 'period': 3个月,'valid_period': 90, 'price': 30},
                    ]
                },
                2: {
                    id: 2,
                    ...
                    choice_policy_id: 4,
                    price_policy_list:[
                        {'id': 4, 'period': 1个月,'valid_period': 30, 'price': 10},
                        {'id': 5, 'period': 2个月,'valid_period': 60, 'price': 20},
                        {'id': 6, 'period': 3个月,'valid_period': 90, 'price': 30},
                    ]
                }
            }
            ...
            course_policy_dict = {
                ...
                global_coupon_record_dict:{
                    1: {'id': 1, 'text': '满100减99',money:99},
                    2: {'id': 2, 'text': '7折',money: 70},
                    3: {'id': 3, 'text': '立减10', 10},
                }
            }
